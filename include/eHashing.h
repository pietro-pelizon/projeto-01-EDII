...
typedef struct stFileHeader FileHeader;
...
bool eHashing_insert(eHashing *map, const void *data, const char *key);
...
void *eHashing_remove(eHashing *map, const char *key);
